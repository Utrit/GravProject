...
public class NonecludianSurface : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        var localToWorldCamMatrix = _mainCamera.transform.localToWorldMatrix;
    ...
    void ObliqueNearClip()
    {
        ...
        _otherCamera.projectionMatrix = _mainCamera.CalculateObliqueMatrix(clipPlaneCameraSpace);
    }
}
